...
import com.group.libraryapp.repository.user.loanhistory.UserLaonHistoryQuerydslRepository
...
class BookService(
    ...
    private val userLoanHistoryQuerydslRepository: UserLaonHistoryQuerydslRepository
) {
    @Transactional
